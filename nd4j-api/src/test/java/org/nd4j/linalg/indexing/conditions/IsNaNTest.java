...
/**
 * The class <code>IsNaNTest</code> contains tests for the class <code>{@link IsNaN}</code>.
 *
...
public class IsNaNTest {
	...
	public void testApply_1()
		...
		//    java.lang.ClassNotFoundException: org.nd4j.linalg.indexing.conditions.IsNaN
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(IsNaNTest.class);
	}
}